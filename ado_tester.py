...
_k8sep.ProjectId = 'charlie'
_k8sep.EnvironmentId = 'charlie-env-1'
_k8sep.Name = 'charlie-dev-1'
_k8sep.Namespace = 'default'
_k8sep.ClusterName = 'charlie-dev-1' 
_k8sep.ServiceEndpointId = 'charlie-dev-1'
...
#inputs = {'action':'project-delete','name':'queen'}
#inputs = {'action':'endpoint-get',"project":"charlie","name":"charlie-dev-1"}
...
#inputs = {'action':'resource-list','project':'charlie'}
inputs = {'action':'resource-list'}

#inputs = {'action':'resource-create',"project":"alpha","name":"tap1","environment":"env8","endpoint":"tap1","cluster":"tap1","namespace":"default"}
#inputs = {'action':'resource-get',"project":"alpha","name":"tap1","environment":"env8"}
